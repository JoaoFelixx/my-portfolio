const Projects = {
  ...
  title: {
    ...
    quiz: 'Jogo Quiz',
    fsNode: 'Sistema de arquivos com Node JS ',
    api: "API ('Application','Programming','Interface') com Node",
    loginSimulator: "Simulador de Login",
    loginPHP: 'Sistema de Login completo com PHP',
  ...
  content: {
    ...
    fsNode: 'Esse é um sistema simples de como fazer uploads de arquivos com Node JS (imagens, vídeos, PDF, etc.) com esse sistema você pode fazer implementações para plataformas como S3 (AWS). É um bom começo para fazer um sistema grande !',
    ...
    loginPHP: 'Projeto desenvolvido com PHP a “linguagem mais famosa” da web, Esse sistema foi feito colocando o máximo de simplicidade dentro do código para que até iniciantes na linguagem possam fazer alterações e melhorias.',
